        ...
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-lg text-slate-600">
              You can make predictions only on the match day in IST, so keep an eye on
              today&apos;s fixtures and each cutoff.
            </p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
            <div className="surface-card p-5">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Updates immediately after each settled result.
              </p>
            </div>
            <div className="surface-card p-5">
              <p className="font-heading text-sm uppercase tracking-[0.24em] text-blue-600">
      ...
      <section className="space-y-5">
        ...
        {dashboard.upcoming.length > 0 ? (
          ...
          <EmptyState
            ...
            description="All upcoming fixtures are settled or the schedule has finished. The season table should be getting spicy by now."
          />
        )}
      </section>
